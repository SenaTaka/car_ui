...
enum PIDCatalog {
    ...
    static let all: [PIDDefinition] = [
        ...
        PIDDefinition(pid: 0x05, name: String(localized: "冷却水温"), unit: "°C", icon: "thermometer.medium", gaugeRange: -40...140, fractionDigits: 0, decode: tempA),
        ...
        PIDDefinition(pid: 0x0F, name: String(localized: "吸気温"), unit: "°C", icon: "wind", gaugeRange: -40...120, fractionDigits: 0, decode: tempA),
        ...
        PIDDefinition(pid: 0x3C, name: String(localized: "触媒温度 B1S1"), unit: "°C", icon: "flame", gaugeRange: -40...1200, fractionDigits: 0, decode: catalystTemp),
        PIDDefinition(pid: 0x3D, name: String(localized: "触媒温度 B2S1"), unit: "°C", icon: "flame", gaugeRange: -40...1200, fractionDigits: 0, decode: catalystTemp),
        PIDDefinition(pid: 0x3E, name: String(localized: "触媒温度 B1S2"), unit: "°C", icon: "flame.fill", gaugeRange: -40...1200, fractionDigits: 0, decode: catalystTemp),
        PIDDefinition(pid: 0x3F, name: String(localized: "触媒温度 B2S2"), unit: "°C", icon: "flame.fill", gaugeRange: -40...1200, fractionDigits: 0, decode: catalystTemp),
        ...
        PIDDefinition(pid: 0x46, name: String(localized: "外気温"), unit: "°C", icon: "thermometer.sun", gaugeRange: -40...60, fractionDigits: 0, decode: tempA),
        ...
        PIDDefinition(pid: 0x5C, name: String(localized: "エンジン油温"), unit: "°C", icon: "oilcan", gaugeRange: -40...160, fractionDigits: 0, decode: tempA),
